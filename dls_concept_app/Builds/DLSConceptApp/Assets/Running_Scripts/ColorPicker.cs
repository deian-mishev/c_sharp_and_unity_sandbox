...
namespace DLSConceptAppVisual
{
	public class ColorPicker : MonoBehaviour {
		...
		public Vector2 startPos = new Vector2 (20, 0);
		...
		void Start()
		{
			...
			if(receiver)
			{
				object[] tempStorage = new object[2]{this, Title};
				receiver.SendMessage(colorGetFunctionName, tempStorage, SendMessageOptions.DontRequireReceiver);
			}
		}
		...
		public void _DrawGUI () 
		{
			...
			Rect rectColorEdit = new Rect(startPos.x + sizeCurr + 10, startPos.y + 30, 20, 60);
			Rect rectColorSlider = new Rect(startPos.x + sizeCurr + 50, startPos.y + 30, 40, 60);
			...
			if(mState == ESTATE.Showed)
			{
				...
				if(GUI.Button(new Rect(startPos.x + sizeCurr + 10, startPos.y + 150, 60, 20), "Apply"))
				{
					...
					if(receiver)
					{
						object[] tempStorage = new object[2]{SelectedColor, Title};
						receiver.SendMessage(colorSetFunctionName, tempStorage, SendMessageOptions.DontRequireReceiver);
					}
				}
				...
				GUI.Label(new Rect(startPos.x + sizeCurr + 110, startPos.y + 120, 20, 20), "E", labelStyleRGBA);
			}
